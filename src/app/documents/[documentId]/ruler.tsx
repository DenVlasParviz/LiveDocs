    ...
    return (
        ...
        <div ref={rulerRef} onMouseMove={handleMouseMove} onMouseUp={handleMouseUp} onMouseLeave={handleMouseUp}
            ...
            <div id='ruler-container' className='max-w-[816px] mx-auto w-full h-full relative'>
                <Marker position={leftMargin} isLeft={true} isDragging={isDraggingLeft}
                        onMouseDown={handleLeftMouseDown} onDoubleClick={handleLeftDoubleClick}/>
                <Marker position={rightMargin} isLeft={false} isDragging={isDraggingRight}
                        onMouseDown={handleRightMouseDown} onDoubleClick={handleRightDoubleClick}/>
        ...
        >
            ...
            <div
                style={{
                    ...
                    bottom: 0,
                    width: '2px',
                    transform: 'translateX(-50%)', // один transform, не конфликтует с Tailwind
